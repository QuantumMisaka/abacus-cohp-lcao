...
|---|---:|---|---|
| ABACUS relax, efficiency basis | 408431 | COMPLETED | `examples/validation-bundles/ni100_co_top/abacus_relax_efficiency` |
| ABACUS SCF/COHP, efficiency basis | 408561 | COMPLETED | `examples/validation-bundles/ni100_co_top/abacus_scf_efficiency` |
| ABACUS SCF/COHP, precision basis | 408562 | COMPLETED | `examples/validation-bundles/ni100_co_top/abacus_scf_precision` |
...
Relevant plotted data are in `examples/validation-bundles/ni100_co_top/analysis/`:
