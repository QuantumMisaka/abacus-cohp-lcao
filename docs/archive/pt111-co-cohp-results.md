...
- 工作流脚本：`scripts/experimental/pt111_co_workflow.py`
- nspin=1:
...
- `python -m py_compile src/cohp.py src/read_abacus_out.py scripts/experimental/pt111_co_workflow.py`
